#ifndef TOKEN_SUBTRACT_HPP
#define TOKEN_SUBTRACT_HPP
...
public:
  explicit Subtract(std::string t, size_t tLine, size_t tColumn,
  ...
  Subtract &operator=(Subtract &&) = default;

  TokenType tokenType() const final { return SUBTRACT; }
  ...
  void assemble(int16_t &programCounter, size_t width,
    ...
    const uint16_t bin = 0x5000 | (symbol->second.address() & 0xFFF);
