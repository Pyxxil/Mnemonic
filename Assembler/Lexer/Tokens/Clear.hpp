#ifndef TOKEN_CLEAR_HPP
#define TOKEN_CLEAR_HPP
...
public:
  explicit Clear(std::string t, size_t tLine, size_t tColumn,
  ...
  Clear &operator=(const Clear &) = default;
  Clear &operator=(Clear &&) = default;

  TokenType tokenType() const final { return CLEAR; }
  ...
  void assemble(int16_t &programCounter, size_t width,
    ...
    const uint16_t bin = 0x2000 | (symbol->second.address() & 0xFFF);
