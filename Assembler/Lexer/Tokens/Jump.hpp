#ifndef TOKEN_JUMP_HPP
#define TOKEN_JUMP_HPP
...
public:
  explicit Jump(std::string t, size_t tLine, size_t tColumn,
  ...
  Jump &operator=(const Jump &) = default;
  Jump &operator=(Jump &&) = default;

  TokenType tokenType() const final { return JUMP; }
  ...
  void assemble(int16_t &programCounter, size_t width,
    ...
    const uint16_t bin = 0x8000 | (symbol->second.address() & 0xFFF);
